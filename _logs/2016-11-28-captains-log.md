---
layout: log
title: "Historical Activity Log - 2016-11-28"
date: "2016-11-28"
tags: ["historical"]
mood: routine
organs_touched:
...
**3 commits** across **1 repos** in **1 organs** since Nov 28, 2016.

### ORGAN II — Poiesis
- **a-mavs-olevm** (3 commits): restructured the vendor js folder, set up npm test for dev & added git ignore for npm debug logs, init commit
