---
layout: log
title: "Historical Activity Log - 2016-12-30"
date: "2016-12-30"
tags: ["historical"]
mood: routine
organs_touched:
...
**1 commits** across **1 repos** in **1 organs** since Dec 30, 2016.

### ORGAN II — Poiesis
- **a-mavs-olevm** (1 commits): STILLS: added animations to buttons, fade in to image, and fixed the problem with the caption when going backward.
