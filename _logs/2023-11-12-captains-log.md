---
layout: log
title: "Historical Activity Log - 2023-11-12"
date: "2023-11-12"
...
**3 commits** across **1 repos** in **1 organs** since Nov 12, 2023.

### ORGAN III — Ergon
- **a-i-chat--exporter** (3 commits): CI build, chore: release userscript 2.17.1, fix: replace latex annotation `\[ \] \( \)` with $ for better compatibility
