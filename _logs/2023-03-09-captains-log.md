---
layout: log
title: "Historical Activity Log - 2023-03-09"
date: "2023-03-09"
...
**3 commits** across **1 repos** in **1 organs** since Mar 09, 2023.

### ORGAN III — Ergon
- **a-i-chat--exporter** (3 commits): fix: use title from API in markdown and html export, fix: improve layout and style, fix: fix wrong dimensions of user pfp in screenshot export
